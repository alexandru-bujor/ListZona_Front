  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative mx-auto px-4 pb-16 pt-12 sm:pt-20 lg:pb-24 lg:pt-28">
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="mb-6 flex items-end justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">{t("home.featured_sub")}</p>
          </div>
          <Link
            to="/listings"
      ...
      {/* RECENT */}
      <section className="container mx-auto px-4 py-12">
        <h2 className="mb-6 text-2xl font-bold sm:text-3xl">Fresh near you</h2>
